...
public class MetodoMain {
	...
	public static void main(String[] args) {
		...
		// Saída de dados para mostrar as posições dos ponteiros no relógio analógico
		JOptionPane.showMessageDialog(null, "Posição das horas: " + r1.ponteiroHora.posicao + "\n" +
									  "Posição dos minutos: " + r1.ponteiroMinuto.posicao + "\n" + 
									  "Posição dos minutos: " + r1.ponteiroSegundo.posicao);
